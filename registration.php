  ...
  <?php echo "<script> showAlert('$errormsg') </script>"; ?>
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            ...
            <form style="margin-top: 10px; margin-bottom: 10px;" action="registration.php" method="POST" onsubmit="return checkform(this);">
