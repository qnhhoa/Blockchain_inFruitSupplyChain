...
<html lang="en">
  <head>
    ...
    <title>Cập nhật nguồn cung cấp</title>
        ...
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form2" autocomplete="off">
                    ...
                    <div class="formitem">
                        <!-- <label type="text" class="formlabel"> Tên nhà cung cấp </label>
                        <input type="text" class="forminput" id="source" required> -->
                        <label type="text" class="formlabel"> Loại trái cây </label>
                        <input type="text" class="forminput" id="type" required>
                        <label type="text" class="formlabel"> Ngày thu hoạch </label>
                        <input type="text" class="forminput" id="date" required>
