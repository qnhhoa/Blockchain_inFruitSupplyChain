    ...
    <div class="bgroles">
      <center>
        <div class="mycardstyle">
            <div class="greyarea">
                <h5> Điền thông tin cập nhật vận chuyển </h5>
                <form id="form2" autocomplete="off">
                    ...
                    <div class="formitem">
                        <label type="text" class="formlabel"> Vị trí trung tâm vận chuyển </label>
                        <input type="text" class="forminput" id="prodlocation" required>
                        <label type="text" class="formlabel"> Nơi đi </label>
                        <input type="text" class="forminput" id="from" required>
                        <label type="text" class="formlabel"> Nơi đến </label>
                        <input type="text" class="forminput" id="to" required>
...
contractAddress = '0x1dC2dB22587C93ec73076B63053BBFfa6b495cd2';
    ...
    $('#form2').on('submit', function(event) {
        ...
        var today = new Date();
        var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
        var info = "<br><br><b>Ngay van chuyen: "+thisdate+"</b><br>Vi tri kho: "+prodlocation +"</b><br>Noi di: "+from+"</b><br>Noi den: "+to+"<br>Don vi van chuyen: "+username;
        web3.eth.getAccounts().then(async function(accounts) {
          var receipt = await contract.methods.addState(prodid, info).send({ from: accounts[1], gas: 1000000 })
          .then(receipt => {
